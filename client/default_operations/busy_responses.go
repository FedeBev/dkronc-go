...
func (o *BusyOK) Error() string {
	return fmt.Sprintf("[GET /busy][%d] busyOK  %+v", 200, o.Payload)
}
func (o *BusyOK) GetPayload() []*models.Execution {
	return o.Payload
}

func (o *BusyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
